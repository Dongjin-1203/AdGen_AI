...
from diffusers.models import AutoencoderKL, UNet2DConditionModel # ImageProjection removed
...
class StableDiffusionXLInpaintPipeline(
    ...
    def prepare_ip_adapter_image_embeds(self, ip_adapter_image, device, num_images_per_prompt):
        ...
        #     )
        output_hidden_state = True # Was: not isinstance(self.unet.encoder_hid_proj, ImageProjection) -> assume not ImageProjection
